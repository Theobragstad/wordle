...
class Wordle:
    ...
    def start(self):
        ...
        if mode == 0:
            ...
            self.handle_random_mode()

        elif mode == 3:
            self.handle_ai_mode()

    def handle_random_mode(self):
    ...
    def handle_ai_mode(self):        
        ...
        for i in range(1, simulation_count + 1):
            if show_full_output:
                print(f"\nGame {i}")
            round_won = self.play_ai(show_full_output)
            if round_won > 0:
                round_total += round_won
                win_count += 1
        ...
        print(f"\n{simulation_count} AI {game_string}")
        print(
    ...
    def play_ai(self, show_full_output):
